    ...
    <div className="about-container w-full">
      ...
      <div className="about-section min-h-screen flex flex-col lg:flex-row">
        ...
        <img
          ...
          alt="Gaming"
          className="w-full lg:w-1/2 h-64 md:h-96 lg:h-4/6 "
        />
        <div className="para w-full lg:w-1/2 lg:h-4/6 flex flex-col justify-center p-6 md:p-12 lg:px-12 bg-green-900 text-gray-200">
