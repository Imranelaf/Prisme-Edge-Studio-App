...
export const Navbar = ({ session }: NavbarProps) => {
    ...
    return (
        <nav className="w-full min-h-[8vh] h-fit bg-white shadow-md border-b border-gray-200 fixed top-0 left-0 right-0 z-50">
            <div className="px-4 md:px-8 py-4">
                ...
                {/* Mobile Navigation */}
                {isMenuOpen && (
                    <div className="md:hidden mt-4 pb-4 absolute top-full left-0 right-0 bg-white shadow-md">
