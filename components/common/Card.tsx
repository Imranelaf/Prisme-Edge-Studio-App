...
export const Card = () => {
  ...
  return (
    <div className="grid grid-cols-[repeat(auto-fill,_minmax(250px,_1fr))] grid-rows-[350px] gap-8 p-8">
      ...
      <div key={0} className="flex items-center justify-center bg-yellow-400 rounded-lg text-2xl font-bold text-gray-800 transition-transform duration-200 cursor-pointer hover:transform hover:translate-x-1 hover:translate-y-[-5px] hover:shadow-lg">
        <h2>Show ALL</h2>
      </div>
    </div>
  )
